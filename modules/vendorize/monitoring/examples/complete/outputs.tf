...
output "iam_mode" {
  ...
  value       = module.monitoring_stack.iam_mode
}
...
output "pod_identity_role_arn" {
  ...
  value       = module.monitoring_stack.pod_identity_role_arn
}
...
output "sizing_preset" {
  ...
  value       = module.monitoring_stack.sizing_preset
}

output "enterprise_features" {
  description = "Map of enterprise feature enablement status"
  value       = module.monitoring_stack.enterprise_features
}
