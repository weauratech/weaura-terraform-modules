# Mimir Distributed - Standalone Values Template
# This template is used by helm_mimir.tf for the mimir-distributed Helm chart
# All keys are at root level (not nested under 'mimir:')
